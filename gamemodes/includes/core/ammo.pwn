...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[]) {
	...
	switch(dialogid)
	{
		...
		{
			if(!response) 
				return SendClientMessageEx(playerid, COLOR_YELLOW, "Cam on ban da mua hang tai Ammunation! Hen gap lai!");
		...
		case DIALOG_AMMUNATION_GUNS:
		{
			if(PlayerInfo[playerid][pGunLic] < gettime())
				return SendClientMessageEx(playerid, COLOR_GREY, "Ban phai co giay phep hoat dong de mua sung tu cua hang ban sung!");
			if(!response)
			...
			switch(listitem)
			{
				case 0: // 9mm Pistol
				{
					...
					if(PlayerInfo[playerid][pCash] < GunPrices[0]) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong co du tien!");
					if(Businesses[business][bInventory] < iWeaponMats) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua 9mm pistol voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[0]), Businesses[business][bName]);
				...
				case 1: // Pump Shotgun 
				{
					...
					if(PlayerInfo[playerid][pCash] < GunPrices[1]) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong co du tien!");
					if(Businesses[business][bInventory] < iWeaponMats) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua ShotGun voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[1]), Businesses[business][bName]);
					SendClientMessageEx(playerid, -1, szMiscArray);
					Log("logs/business.log", szMiscArray);
				}
				case 2: // Deagle
				{
					...
					if(PlayerInfo[playerid][pCash] < GunPrices[2]) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong co du tien!");
					if(Businesses[business][bInventory] < iWeaponMats) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua Deagle voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[2]), Businesses[business][bName]);
					SendClientMessageEx(playerid, -1, szMiscArray);
					Log("logs/business.log", szMiscArray);
				}
			}
		...
		case DIALOG_AMMUNATION_AMMO:
		{
			...
			switch(listitem)
			{
				case 0: // Pistol Ammo
				{
					...
					if(Businesses[business][bInventory] < (GunPrices[3]/1000)) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua Pistol Ammo voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[3]), Businesses[business][bName]);
					SendClientMessageEx(playerid, -1, szMiscArray);
					Log("logs/business.log", szMiscArray);
				}
				case 1: // Shotgun Ammo
				{
					...
					if(Businesses[business][bInventory] < (GunPrices[4]/1000)) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua Shotgun ammo voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[4]), Businesses[business][bName]);
					SendClientMessageEx(playerid, -1, szMiscArray);
					Log("logs/business.log", szMiscArray);
				}
				case 2: // Deagle ammo
				{
					...
					if(Businesses[business][bInventory] < (GunPrices[5]/1000)) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua Deagle Ammo voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[5]), Businesses[business][bName]);
					SendClientMessageEx(playerid, -1, szMiscArray);
					Log("logs/business.log", szMiscArray);
				}
				case 3: // Rifle ammo
				{
					...
					if(Businesses[business][bInventory] < (GunPrices[6]/1000)) return SendClientMessageEx(playerid, COLOR_WHITE, "Doanh nghiep nay da het hang");
					...
					format(szMiscArray, sizeof(szMiscArray), "%s da mua Rifle Ammo voi gia $%s tai %s", GetPlayerNameEx(playerid), number_format(GunPrices[6]), Businesses[business][bName]);
					SendClientMessageEx(playerid, -1, szMiscArray);
					Log("logs/business.log", szMiscArray);
				}
			}
...
CMD:issuegunlicense(playerid, params[])
{
	if((0 <= PlayerInfo[playerid][pLeader] < MAX_GROUPS) && arrGroupData[PlayerInfo[playerid][pLeader]][g_iGroupType] == GROUP_TYPE_GOV)
	{
		...
		if(sscanf(params, "u", iTargetID)) return SendClientMessageEx(playerid, COLOR_GRAD2, "SU DUNG: /issuegunlicense [playerid]");

		PlayerInfo[iTargetID][pGunLic] = gettime() + (86400*30);

		format(szMiscArray, sizeof(szMiscArray), "%s da doi moi %s's giay phep su dung vu khi.", GetPlayerNameEx(playerid), GetPlayerNameEx(iTargetID));
...
CMD:muavukhi(playerid, params[])
{
	...
	if(business == INVALID_BUSINESS_ID || Businesses[business][bType] != BUSINESS_TYPE_GUNSHOP) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong o tiem sung!");
	if(PlayerInfo[playerid][pConnectHours] < 8) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban chua choi du gio de co duoc vu khi!");
...
CMD:napdan(playerid, params[])
{
	...
	if(DynVeh[iVehID] == -1 || DynVehicleInfo[DynVeh[iVehID]][gv_iType] != 2) return SendClientMessageEx(playerid, COLOR_WHITE, "Xe nay khong duoc nap dan.");
	if(DynVehicleInfo[DynVeh[iVehID]][gv_iAmmoLoaded] > 0) return SendClientMessageEx(playerid, COLOR_WHITE, "Chiec xe nay da duoc nap day dan.");
	if(0 <= iGroupID < MAX_GROUPS && (arrGroupData[iGroupID][g_iGroupType] == GROUP_TYPE_GOV || arrGroupData[iGroupID][g_iGroupType] == GROUP_TYPE_LEA))
	{
		for(new i = 0; i < MAX_BUSINESSES; i++)
		{
			if(IsPlayerInRangeOfPoint(playerid, 5.0, Businesses[i][bSupplyPos][0], Businesses[i][bSupplyPos][1], Businesses[i][bSupplyPos][2]) && Businesses[i][bType] == BUSINESS_TYPE_GUNSHOP)
			{
				...
				SendClientMessageEx(playerid, COLOR_WHITE, "Ban da nap dan vao xe cua minh. Giao no tro lai HQ cua ban. ");

				format(szMiscArray, sizeof(szMiscArray), "%s da tra $100.000 de tiep te thung dan tai %s (%d).", GetPlayerNameEx(playerid), Businesses[i][bName], i);
				Log("logs/business.log", szMiscArray);

				format(szMiscArray, sizeof(szMiscArray), "%s da tra $100.000 de tiep te thung dan.", GetPlayerNameEx(playerid));
				GroupLog(iGroupID, szMiscArray);
				break;
			}
		}
	}
	else SendClientMessageEx(playerid, COLOR_WHITE, "Ban phai la LEO de su dung lenh nay");
	return 1;
}

CMD:vanchuyendan(playerid, params[])
{
	new iVehID = GetPlayerVehicleID(playerid);
	new iGroupID = PlayerInfo[playerid][pMember];
	...
	if(DynVeh[iVehID] == -1 || DynVehicleInfo[DynVeh[iVehID]][gv_iType] != 2) return SendClientMessageEx(playerid, COLOR_WHITE, "Phuong tien nay khong duoc chi dinh de van chuyen dan.");
	if(DynVehicleInfo[DynVeh[iVehID]][gv_iAmmoLoaded] == 0) return SendClientMessageEx(playerid, COLOR_WHITE, "Xe nay khong co dan.");
	if(0 <= iGroupID < MAX_GROUPS && (arrGroupData[iGroupID][g_iGroupType] == GROUP_TYPE_GOV || arrGroupData[iGroupID][g_iGroupType] == GROUP_TYPE_LEA))
	{
		for(new i = 0; i < MAX_GROUPS; i++)
		{
			if(IsPlayerInRangeOfPoint(playerid, 6, arrGroupData[i][g_fCratePos][0], arrGroupData[i][g_fCratePos][1], arrGroupData[i][g_fCratePos][2]))
			{
				...
				format(szMiscArray, sizeof(szMiscArray), "%s giao mot thung dan.", GetPlayerNameEx(playerid));
				GroupLog(iGroupID, szMiscArray);

				SendClientMessageEx(playerid, COLOR_WHITE, "Ban da chuyen dan den tru so cua ban. ");
				break;
			}
		}
	}
...
ListAmmo(playerid, targetid)
{
	...
	format(szMiscArray, sizeof(szMiscArray), "Dan tren %s:", GetPlayerNameEx(targetid));
...
CMD:seeammo(playerid, params[]) {
	if(PlayerInfo[playerid][pAdmin] < 2) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong the su dung lenh nay!");
	new target;
	if(sscanf(params, "u", target)) return SendClientMessageEx(playerid, COLOR_GRAD2, "SU DUNG: /seeammo [playerid]");
	if(!IsPlayerConnected(target)) return SendClientMessageEx(playerid, COLOR_GRAD2, "Nguoi choi khong duoc ket noi");
...
CMD:setammo(playerid, params[]) {
	...
	if(PlayerInfo[playerid][pAdmin] < 4 && PlayerInfo[playerid][pASM] < 1) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong the su dung lenh nay!");
	if(sscanf(params, "uii", iTargetID, iAmmoType, iAmount)) return SendClientMessageEx(playerid, COLOR_GRAD2, "SU DUNG: /setammo [playerid] [type (0 - 3)] [amount]");
	if(!IsPlayerConnected(iTargetID)) return SendClientMessageEx(playerid, COLOR_GRAD2, "Nguoi choi khong duoc ket noi.");
	if(iAmount < 1) return SendClientMessageEx(playerid, COLOR_GRAD2, "So luong khong duoc nho hon 1.");

	format(szMiscArray, sizeof(szMiscArray), "Ban da dua cho %s %i vien dan (loai:%i)", GetPlayerNameEx(iTargetID), iAmount, iAmmoType);
	SendClientMessageEx(playerid, COLOR_WHITE, szMiscArray);
	
	format(szMiscArray, sizeof(szMiscArray), "%s(%s) da cho %s(%d) (%s) %i vien dan (loai:%i)", GetPlayerNameEx(playerid), GetPlayerIpEx(playerid), GetPlayerNameEx(iTargetID), GetPlayerSQLId(iTargetID), GetPlayerIpEx(iTargetID), iAmount, iAmmoType);
...
CMD:vipgunsleft(playerid, params[]) {
	...
	szMiscArray[0] = 0;
	if(PlayerInfo[playerid][pDonateRank] < 1) return SendClientMessageEx(playerid, COLOR_GRAD2, "Ban khong phai la thanh vien vip.");

	switch(PlayerInfo[playerid][pDonateRank]) {
		case 4: format(szMiscArray, sizeof(szMiscArray), "%s co %d lay sung con lai ngay hom nay [VIP]!", GetPlayerNameEx(playerid), 8-PlayerInfo[playerid][pVIPGuncount]);
		default: format(szMiscArray, sizeof(szMiscArray), "%s co %d lay sung con lai ngay hom nay [VIP]!", GetPlayerNameEx(playerid), 4-PlayerInfo[playerid][pVIPGuncount]);
	}
...
CMD:editgsprices(playerid, params[]) {
	...
	if(PlayerInfo[playerid][pAdmin] < 1337) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong duoc phep su dung lenh nay!");

	if(sscanf(params, "s[32]d", choice, amount)) {
		SendClientMessageEx(playerid, COLOR_WHITE, "SU DUNG: /editgsprices [lua chon] [so luong]");
		SendClientMessageEx(playerid, COLOR_WHITE, "Lua chon co san: colt45, shotgun, deagle, pistolm, shotgunm, deaglem, riflem");
	...
	if(strcmp(choice, "colt45", true) == 0) {
		GunPrices[0] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia colt45 thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	if(strcmp(choice, "shotgun", true) == 0) {
		GunPrices[1] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia shotgun thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	if(strcmp(choice, "deagle", true) == 0) {
		GunPrices[2] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia deagle thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	if(strcmp(choice, "pistolm", true) == 0) {
		GunPrices[3] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia Pistol Ammo thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	if(strcmp(choice, "shotgunm", true) == 0) {
		GunPrices[4] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia Shotgun Ammo thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	if(strcmp(choice, "deaglem", true) == 0) {
		GunPrices[5] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia Deagle Ammo thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	if(strcmp(choice, "riflem", true) == 0) {
		GunPrices[6] = amount; 
		format(szMiscArray, sizeof(szMiscArray), "%s da thay doi gia Rifle Ammo thanh $%s", GetPlayerNameEx(playerid), number_format(amount));
		Log("logs/business.log", szMiscArray);
		g_mysql_SaveMOTD();
	}
	g_mysql_SaveMOTD();
...
CMD:oissuegunlicense(playerid, params[])
{
	if((0 <= PlayerInfo[playerid][pLeader] < MAX_GROUPS) && arrGroupData[PlayerInfo[playerid][pLeader]][g_iGroupType] == GROUP_TYPE_GOV)
	{
		...
		if(sscanf(params, "s[24]", TargetName)) return SendClientMessageEx(playerid, COLOR_GRAD2, "SU DUNG: /oissuegunlicense [playerid]");
...
CMD:orevokegunlicense(playerid, params[])
{
	if((0 <= PlayerInfo[playerid][pLeader] < MAX_GROUPS) && arrGroupData[PlayerInfo[playerid][pLeader]][g_iGroupType] == GROUP_TYPE_GOV || PlayerInfo[playerid][pLeader] == 1)
	{
		szMiscArray[0] = 0;
		new TargetName[MAX_PLAYERS];
		if(sscanf(params, "s[24]", TargetName)) return SendClientMessageEx(playerid, COLOR_GRAD2, "SU DUNG: /orevokegunlicense [playerid]");
		if(IsPlayerConnected(ReturnUser(TargetName))) return cmd_issuegunlicense(playerid, params);
