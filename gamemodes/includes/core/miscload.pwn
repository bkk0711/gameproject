...
hook OnGameModeInit() {
	...
	TD_ServerError = TextDrawCreate(321.000000, 428.000000, "MAY CHU: Lenh nay khong ton tai");
...
stock Misc_Load() {
	...
	if(iRewardBox) {
		...
		tRewardText = CreateDynamic3DTextLabel("Hop Qua Vang\n{FFFFFF}/getrewardgift{F3FF02} de nhan qua!", COLOR_YELLOW, fObjectPos[0], fObjectPos[1], fObjectPos[2], 10.0, .testlos = 1, .streamdistance = 50.0);
	}
	if(FIFEnabled == 1)
	{
