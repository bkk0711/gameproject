...
CMD:toganimhelper(playerid, params[])
{
	...
	{
		SendClientMessage(playerid, -1, "Ban da thiet lap lai hanh dong tro giup.");
		DeletePVar(playerid, "togAnimHelper");
	}
	else
	{
		SendClientMessage(playerid, -1, "Ban da tat hanh dong tro giup.");
...
{
	if(!IsPlayerIdle(playerid)) return SendClientMessageEx(playerid, COLOR_WHITE, "Ban phai dung hanh dong hien tai cua ban!");
...
IsAblePedAnimation(playerid)
{
    if(GetPVarType(playerid, "PlayerCuffed") || GetPVarInt(playerid, "pBagged") >= 1 || GetPVarType(playerid, "Injured") || GetPVarType(playerid, "IsFrozen") || PlayerInfo[playerid][pHospital]!= 0 || GetPVarType(playerid, "IsLive") || GetPVarInt(playerid, "jailcuffs") == 1 || GetPVarType(playerid, "FixVehicleTimer") || CarryCrate[playerid] != -1) {
   		SendClientMessage(playerid, COLOR_GRAD2, "Ban khong the thuc hien bay gio!");
   		return 0;
	}
    if(IsPlayerInAnyVehicle(playerid) == 1)
    {
		SendClientMessage(playerid, COLOR_GRAD2, "Hanh dong nay doi hoi ban phai o ngoai mot chiec xe.");
		return 0;
	}
	return 1;
}
...
public StopaniTimer(playerid)
{
	...
	{
	    SendClientMessageEx (playerid, COLOR_YELLOW, "Khong the dung hanh dong vi ban dang di chuyen!");
    	for(new i = 0; i < 3; i++)
		{
	...
	SendClientMessageEx (playerid, COLOR_YELLOW, "Ban da dung hanh dong!");
	ClearAnimationsEx(playerid);
...
CMD:hanhdong(playerid, params[]) return cmd_animlist(playerid, params);
CMD:animlist(playerid, params[])
{
	SendClientMessage(playerid, COLOR_GREEN, "Hanh Dong Co San:");
	...
	SendClientMessage(playerid, COLOR_GREEN, "Dung /stopani de dung hanh dong.");
	SendClientMessage(playerid, COLOR_GREEN, "Dung /toganimhelper de tat Textdraw phia duoi.");
	return 1;
}
...
CMD:stopani(playerid, params[])
{
	...
	{
	    SendClientMessageEx(playerid, COLOR_GREY, "Ban dang co gang dung hanh dong cua ban!");
		return 1;
	}
	...
	else
	{
		...
		SendClientMessageEx (playerid, COLOR_YELLOW, "Khong di chuyen trong 10 giay de xoa hanh dong cua ban!");
	}
	return 1;
}
CMD:battay(playerid, params[]) return cmd_shakehand(playerid, params);
CMD:shakehand(playerid, params[])
{
	...
	if(IsPlayerConnected(giveplayerid) || (PlayerInfo[giveplayerid][pAdmin] >= 2 && PlayerInfo[playerid][pTogReports] == 0))
	{
		...
		{
			SendClientMessageEx(playerid, COLOR_GREY, "Ban khong the bat tay ban.");
			return 1;
		}
		else if(PlayerInfo[giveplayerid][pAdmin] >= 2 && PlayerInfo[giveplayerid][pTogReports] != 1) {
			SendClientMessageEx(playerid, COLOR_GREY, "Ban khong the bat tay nguoi nay.");
			return 1;
		}
		if(style >= 1 && style < 9)
		{
			...
			{
				SendClientMessageEx(playerid, COLOR_GREY, "Ban o qua xa. Ban khong the bat tay ngay bay gio.");
				return 1;
			}
			...
			format(string, sizeof(string), "Ban da yeu cau bat tay %s's, vui long doi ho tra loi.", GetPlayerNameEx(giveplayerid));
			SendClientMessageEx(playerid, COLOR_WHITE, string);

			format(string, sizeof(string), "%s da yeu cau bat tay voi ban, vui long dung '/chapnhan battay' de dong y bat tay.", GetPlayerNameEx(playerid));
			SendClientMessageEx(giveplayerid, COLOR_WHITE, string);
		}
		else
		{
			SendClientMessageEx(playerid, COLOR_GREY, "SU DUNG: /shakehand [player] [style (1-8)]");
		}
	}
	else
	{
...
CMD:time(playerid, params[])
{
	...
	{
		format(string, sizeof(string), "~y~%s, %s %d, %d~n~~g~|~w~%d:%02d~g~%s|~n~~w~Thoi gian tu con lai: ~r~%s", GetWeekday(1), mtext, day, year, thour, minuite, suffix, TimeConvert(PlayerInfo[playerid][pJailTime]));
	}
	else
	{
...
CMD:lowbodypunch(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /lowbodypunch [1-2]");
	}
	return 1;
}
...
CMD:fightidle(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /fightidle [1-4]");
	}
	return 1;
}
...
CMD:gesture(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /gesture [1-16]");
	}
	return 1;
}
...
CMD:wave(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /wave [1-4]");
	}
	return 1;
}
...
CMD:fallover(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /fallover [1-12]");
	}
	return 1;
}
...
CMD:pedmove(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /pedmove [1-27]");
	}
	return 1;
}
...
CMD:smoke(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /smoke [1-6]");
	}
	return 1;
}
...
CMD:reload(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /reload [1-7]");
	}
	return 1;
}
...
CMD:crouchreload(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /crouchreload [1-5]");
	}
	return 1;
}
...
CMD:sit(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /sit [1-6]");
	}
	return 1;
}
...
CMD:bar(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /bar [1-9]");
	}
	return 1;
}
...
CMD:spank(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /spank [1-10]");
	}
	return 1;
}
...
CMD:misc(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /misc [1-4]");
	}
	return 1;
}
...
CMD:blowjob(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /blowjob [1-4]");
	}
	return 1;
}
...
CMD:idles(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /idles [1-33]");
	}
	return 1;
}
...
CMD:hitchhike(playerid, params[])
{
	...
	default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /hitchhike [1-2]");
	}
	return 1;
}
...
CMD:bat(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /bat [1-3]");
	}
	return 1;
}
...
CMD:sitonchair(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /sitonchair [1-9]");
	}
	return 1;
}
...
CMD:opendoor(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /opendoor [1-2]");
	}
	return 1;
}
...
CMD:robman(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /robman [1-4]");
	}
	return 1;
}
...
CMD:camera(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /camera [1-9]");
	}
	return 1;
}
...
CMD:bomb(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /bomb [1-2]");
	}
	return 1;
}
...
CMD:beckon(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /beckon [1-3]");
	}
	return 1;
}
...
CMD:carry(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /carry [1-6]");
	}
	return 1;
}
...
CMD:cslot(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /cslot [1-7]");
	}
	return 1;
}
...
CMD:croulette(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /croulette [1-5]");
	}
	return 1;
}
...
CMD:ccards(playerid,params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /ccards [1-6]");
	}
	return 1;
}
...
CMD:pose(playerid,params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /pose [1-7]");
	}
	return 1;
}
...
CMD:crack(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /crack [1-5]");
	}
	return 1;
}
...
CMD:swata(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /swata [1-8]");
	}
	return 1;
}
...
CMD:argue(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /argue [1-2]");
	}
	return 1;
}
...
CMD:presenta(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /presenta [1-2]");
	}
	return 1;
}
...
CMD:pool(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /pool [1-5]");
	}
	return 1;
}
...
CMD:basketball(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /basketball [1-7]");
	}
	return 1;
}
...
CMD:dive(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /dive [1-3]");
	}
	return 1;
}
...
CMD:getup(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /getup [1-2]");
	}
	return 1;
}
...
CMD:robbed(playerid, params[])
{
	...
	switch(strval(params))
	{
		...
		default: SendClientMessage(playerid, COLOR_WHITE, "SU DUNG: /robbed [1-2]");
	}
	return 1;
}
